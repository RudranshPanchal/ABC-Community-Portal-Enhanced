...
//		String resetPass = (String) session.getAttribute("emailForget");
//		User emailUser = userService.emailForgetPass(resetPass);
//		System.out.println(emailUser);
//		return new ModelAndView("ResetPassword", "resetPass", emailUser);
//	}
	@GetMapping(value = "/resetpassword")
	...
	public ModelAndView home(@AuthenticationPrincipal ApplicationUserDetail userDet, HttpSession session, @ModelAttribute("postThread")Thread thread,@ModelAttribute("postJobs")Jobs jobs) {
...
//		System.out.println(tdata);
		List<Jobs> jdata= jtService.showAllJobs();
		return new ModelAndView("Home", "dataT",tdata);
		
		
//		System.out.println(tdata);
		
		//return new ModelAndView("Home", "dataJ", jdata);
	}
